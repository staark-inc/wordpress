...
var L = (i, e, t) => e.has(i) || y("Cannot " + t);
var n = (i, e, t) => (L(i, e, "read from private field"), t ? t.call(i) : e.get(i)), f = (i, e, t) => e.has(i) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t), _ = (i, e, t, s) => (L(i, e, "write to private field"), s ? s.call(i, t) : e.set(i, t), t), m = (i, e, t) => (L(i, e, "access private method"), t);
var b = (i, e, t, s) => ({
  set _(o) {
    _(i, e, o, t);
  },
...
class O extends EventTarget {
   ...
   */
  stage(e, t = "") {
    if (e || (e = this._selfWeight), this._selfWeight - e < -w)
      throw new Error(
  ...
  set(e) {
    this._selfProgress = Math.min(e, 100), this.notifyProgress(), this._selfProgress + w >= 100 && this.finish();
  }
  finish() {
