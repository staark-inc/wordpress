...
export type LimitedPHPApi = Pick<PHP, 'request' | 'defineConstant' | 'mkdir' | 'mkdirTree' | 'readFileAsText' | 'readFileAsBuffer' | 'writeFile' | 'unlink' | 'mv' | 'cp' | 'rmdir' | 'listFiles' | 'isDir' | 'fileExists' | 'chdir' | 'run' | 'runStream' | 'onMessage'> & {
