...
function i() {
  ...
  import("./run-cli-DnHtP68W.js").then((s) => s.c).then(({ parseOptionsAndRunCLI: s }) => {
    s(n).then((e) => {
      if ("exitCode" in e) {
