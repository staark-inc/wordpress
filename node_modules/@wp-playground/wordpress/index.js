import { isLegacyPHPVersion as L, setPhpIniEntries as M, withPHPIniValues as B, sandboxedSpawnHandlerFactory as ae, PHPRequestHandler as oe, PHP as le, writeFiles as D } from "@php-wasm/universal";
import { joinPaths as l, phpVar as h, dirname as b, normalizePath as _e, resolvePathUnder as ce, phpVars as H, basename as ue } from "@php-wasm/util";
import { unzipFile as w, createMemoizedFetch as X } from "@wp-playground/common";
...
async function $e(e, t) {
  return Q(e, t) ? (await me(e, t), await Te(e, t), await Ee(e, t), await we(e, t), await Le(e, t), await be(e, t), await Oe(e, t), !0) : !1;
}
async function ge(e) {
  return Q(e, e.documentRoot) ? (await e.run({
    code: `<?php
...
async function Oe(e, t) {
  await Ne(e, t), await Ae(e, t), await Pe(e, t), await Ue(e, t);
}
...
async function Ae(e, t) {
  ...
  if (e.isDir(i))
    for (const n of e.listFiles(i)) {
      ...
      const s = l(i, n), r = e.readFileAsText(s), a = K(r);
...
const Re = 22527, A = "E_ALL & ~8192 & ~2048";
async function xe(e, t) {
  if (await $e(e, t)) return;
  await Me(e, t), await He(e, t), await Xe(e, t), await Qe(e, t), await ze(e, t), await at(e, t), await Ze(e, t), await it(e, t), await De(e, t), await ke(e, t);
  const i = N(e, t);
  if (i === null) return;
  const n = parseFloat(i);
  Number.isFinite(n) && (n < 1.2 && (await Be(e, t), await Ge(e, t)), n < 1.5 && await Fe(e, t), 1.5 <= n && n < 2 && await tt(e, t), n < 2 && (await Ce(e, t), await Ke(e, t)), 2.1 <= n && n < 2.3 && await We(e, t), n < 2.5 && await Je(e, t), n < 2.8 && (await st(e, t), await rt(e, t)), 2.9 <= n && n < 3.6 && await Ie(e, t), 3.3 <= n && n < 3.4 && await qe(e, t), n >= 4.7 && await ve(e, t));
}
...
if (!defined('WP_CONTENT_DIR')) define('WP_CONTENT_DIR', ABSPATH . 'wp-content');`
  )), s = s.replace(/unset\(\s*\$wp_filter\s*,/, "unset("), s = Ve(s), s = Ye(s), s !== n && await e.writeFile(i, s);
}
function Ve(e) {
...
async function ze(e, t) {
  ...
  )), s = je(s), s !== n && await e.writeFile(i, s);
}
function je(e) {
  const t = [];
  if (e.includes("function set_prefix") || t.push(`
...
async function Ze(e, t) {
  ...
  if (e.isDir(i))
    for (const r of e.listFiles(i)) {
      ...
      const a = l(i, r), o = e.readFileAsText(a), _ = K(o).replace(/ABSPATH\s*\.\s*'\/wp-/g, "ABSPATH . 'wp-");
...
if (defined('PLAYGROUND_AUTO_LOGIN_AS_USER')) {
	if (function_exists('is_user_logged_in') && is_user_logged_in()) {
		...
		${j("PLAYGROUND_AUTO_LOGIN_AS_USER")}
...
async function at(e, t) {
  ...
  if (!e.fileExists(s)) return;
  const r = e.readFileAsText(s);
  /\$wp_queries\s*=\s*"CREATE TABLE/.test(r) && !r.includes("function wp_get_db_schema") && await ot(e, t, s, r);
}
async function ot(e, t, i, n) {
  ...
  if (e.fileExists(u)) {
    const f = e.readFileAsText(u), T = f.replace(
      /(\$alterations\s*=\s*dbDelta\(\s*\$wp_queries\s*\))/g,
      "if ( function_exists('wp_get_db_schema') ) { $wp_queries = wp_get_db_schema(); } $1"
    );
    T !== f && await e.writeFile(u, T);
  }
}
const Z = "@playground-managed";
function lt() {
  return `<?php
// ${Z} — Playground-generated db.php.
...
async function ut(e, t, i = {}) {
  await e.isDir("/tmp/sqlite-database-integration") && await e.rmdir("/tmp/sqlite-database-integration", {
    recursive: !0
  }), await e.mkdir("/tmp/sqlite-database-integration"), await w(e, t, "/tmp/sqlite-database-integration");
  ...
  await e.mv(s, n), await dt(e, n), await e.defineConstant("SQLITE_MAIN_FILE", "1");
...
if(file_exists(${h(o)})) {
	$_pg_db_php = @file_get_contents(${h(o)});
	if (strpos($_pg_db_php, ${h(Z)}) === false) {
		return;
	}
	unset($_pg_db_php);
}
...
const m = 512, F = "/__tar-root__", ft = [40, 181, 47, 253], ht = [80, 75, 3, 4], P = new TextDecoder();
function $t(e) {
  return ft.every((t, i) => e[i] === t);
}
function tn(e) {
  return ht.every((t, i) => e[i] === t);
}
function gt(e) {
  const t = String(e);
  if (t.includes("\\"))
...
function C(e, t, i) {
  ...
  const s = t + i;
  for (; n < s && e[n] !== 0; ) n += 1;
  return P.decode(e.subarray(t, n));
}
function q(e) {
...
class Tt {
  ...
  drain() {
    ...
    for (; t; ) {
      if (t = !1, this.state === "header") {
        if (this.leftover.length < m) break;
        const i = this.leftover.subarray(0, m);
        if (this.leftover = this.leftover.subarray(m), q(i)) {
          this.zeroBlocks += 1, this.zeroBlocks >= 2 && (this.state = "done"), t = !0;
          continue;
        }
        this.zeroBlocks = 0;
        const n = J(i, 124, 12), s = String.fromCharCode(i[156]) || "0", r = C(i, 0, 100), a = C(i, 345, 155);
        if (mt(i, r), !Number.isFinite(n) || n < 0)
          throw new Error(
  ...
  finishEntry() {
    ...
    this.dataChunks = [];
    const n = t.size % m;
    if (this.padRemaining = n === 0 ? 0 : m - n, this.state = this.padRemaining > 0 ? "pad" : "header", this.dataFilled = 0, this.entry = null, t.isLongLink) {
      this.pendingLongName = P.decode(i).replace(/\0.*$/, "");
      return;
    }
    if (t.isPaxHeader) {
      this.pendingPax = bt(i);
      return;
    }
    ...
    const r = t.typeflag === "5" || s.endsWith("/"), a = gt(s);
    if (a) {
      if (r) {
...
async function Et(e, t) {
  ...
  if (t === "zstd") {
    ...
    await s.init();
    const r = await yt(e), a = s.decodeStreaming(r);
    let o = !1;
...
async function wt(e, t, i, n = {}) {
  const { onProgress: s = () => {
    ...
    onEntry: (p) => {
      ...
      _(b(u)), !(!r && ((f = t.fileExists) != null && f.call(t, u))) && (t.writeFile(u, p.data), c.fileCount % 1e3 === 0 && s({
...
function Lt(e) {
  return ee(e) ? e : new Blob([e]).stream();
}
async function yt(e) {
  if (!ee(e))
    return [e];
...
async function Ot(e, t) {
  ...
  ), e.fileExists(i) && await Nt(e, i, {
    DB_NAME: "wordpress"
  });
}
async function nn(e, t, i) {
  const n = H({ wpConfigPath: t, constants: i });
  if ((await e.run({
    code: `${te}
...
async function Nt(e, t, i) {
  const n = Object.keys(i), s = H({ wpConfigPath: t, constantNames: n }), r = await e.run({
    code: `${te}
...
async function Pt(e, t) {
  var r, a;
  if (!L(t.phpVersion)) return;
  const i = (((r = t.phpIniEntries) == null ? void 0 : r.disable_functions) ?? "").split(",").map((o) => o.trim()).filter((o) => o), s = {
    disable_functions: Array.from(
      /* @__PURE__ */ new Set([...i, ...ne])
    ).join(","),
    allow_url_fopen: "0"
  };
  (a = t.phpIniEntries) != null && a["date.timezone"] || (s["date.timezone"] = "UTC"), await M(e, s);
}
async function Ut(e, t) {
  var a, o;
  const i = await e.getPrimaryPhp();
  if ((a = t.hooks) != null && a.beforeWordPressFiles && await t.hooks.beforeWordPressFiles(i), t.wordPressZip && await re(i, await t.wordPressZip, {
    expectedFileCount: t.wordPressBundleFileCount
  }), t.constants)
    for (const _ in t.constants)
      i.defineConstant(_, t.constants[_]);
  i.defineConstant("WP_HOME", t.siteUrl), i.defineConstant("WP_SITEURL", t.siteUrl), await St(i, e.documentRoot), await xe(i, e.documentRoot), (o = t.hooks) != null && o.beforeDatabaseSetup && await t.hooks.beforeDatabaseSetup(i);
  let n = !1;
  t.sqliteIntegrationPluginZip && (n = !0, await se(
    i,
    await t.sqliteIntegrationPluginZip,
    { phpVersion: t.phpVersion }
  ), await Rt(i, e.documentRoot));
  ...
  s === "install-from-existing-files-if-needed") && (await O(e, {
    usesSqlite: n,
...
async function Rt(e, t) {
  ...
  e.isDir(i) && !e.fileExists(n) && await e.writeFile(n, lt());
}
async function xt(e, t) {
  ...
  await _t(e, t.absoluteUrl);
}
async function vt(e) {
  var r, a, o, _, c, d;
  const t = Dt(e, e.documentRoot);
  if (t !== null) {
  ...
  const i = {
    disable_functions: ne.join(","),
    allow_url_fopen: "0",
    error_reporting: String(Re)
  }, n = await B(
    e,
    i,
...
async function sn(e) {
  const t = await Ct(e);
  return await Ft(t, e), t;
}
async function Ft(e, t) {
  var a, o, _, c, d, p, u, f, y, T, U, S, R, x, v, I, k;
  if (L(t.phpVersion))
    return Ut(e, t);
  (a = t.onProgress) == null || a.call(t, "Creating PHP runtime");
  const i = await e.getPrimaryPhp();
  if ((o = t.hooks) != null && o.beforeWordPressFiles && ((_ = t.onProgress) == null || _.call(t, "Mounting WordPress files"), await t.hooks.beforeWordPressFiles(i)), t.wordPressZip && ((c = t.onProgress) == null || c.call(t, "Extracting WordPress files"), await re(i, await t.wordPressZip, {
    expectedFileCount: t.wordPressBundleFileCount
  })), t.constants) {
    (d = t.onProgress) == null || d.call(t, "Defining WordPress constants");
    for (const g in t.constants)
      i.defineConstant(g, t.constants[g]);
  }
  t.dataSqlPath && (i.defineConstant("DB_DIR", b(t.dataSqlPath)), i.defineConstant("DB_FILE", ue(t.dataSqlPath))), i.defineConstant("WP_HOME", t.siteUrl), i.defineConstant("WP_SITEURL", t.siteUrl), (p = t.onProgress) == null || p.call(t, "Starting PHP"), await Ot(i, e.documentRoot), (u = t.hooks) != null && u.beforeDatabaseSetup && ((f = t.onProgress) == null || f.call(t, "Preparing database files"), await t.hooks.beforeDatabaseSetup(i));
  let n = !1;
  t.sqliteIntegrationPluginZip && (n = !0, (y = t.onProgress) == null || y.call(t, "Installing SQLite integration"), await se(
    i,
    await t.sqliteIntegrationPluginZip,
    { phpVersion: t.phpVersion }
  ), await Se(i, e.documentRoot));
  const s = t.wordpressInstallMode ?? "download-and-install", r = !!t.dataSqlPath;
  if (["download-and-install", "install-from-existing-files"].includes(
    s
  )) {
    (T = t.onProgress) == null || T.call(t, "Checking database prerequisites"), await O(e, {
      usesSqlite: n,
      hasCustomDatabasePath: r
    });
    try {
      (U = t.onProgress) == null || U.call(t, "Running WordPress installer"), await W(i);
    } catch (g) {
      throw r || await E(e), g;
    }
    r || ((S = t.onProgress) == null || S.call(t, "Validating database connection"), await E(e));
  } else if (s === "install-from-existing-files-if-needed") {
    if ((R = t.onProgress) == null || R.call(t, "Checking database prerequisites"), await O(e, {
      usesSqlite: n,
      hasCustomDatabasePath: r
    }), (x = t.onProgress) == null || x.call(t, "Checking existing WordPress installation"), !await ie(i))
      try {
        (v = t.onProgress) == null || v.call(t, "Running WordPress installer"), await W(i);
      } catch (g) {
        throw r || await E(e), g;
      }
    r || ((I = t.onProgress) == null || I.call(t, "Validating database connection"), await E(e));
  }
  return (k = t.onProgress) == null || k.call(t, "WordPress boot complete"), e;
}
async function E(e) {
...
async function Ct(e) {
  qt(e);
  const t = e.spawnHandler ?? ae;
  async function i(s, r = !1) {
    const a = await e.createPhpRuntime(r), o = new le(a);
    if (e.sapiName && o.setSapiName(e.sapiName), s && (o.requestHandler = s), e.phpIniEntries && await M(o, e.phpIniEntries), await Pt(o, {
    ...
    */
    !o.isFile("/internal/.boot-files-written") && (await Xt(o, {
      phpVersion: e.phpVersion
    }), await D(o, "/", e.createFiles || {}), await Vt(
      o,
  ...
  const n = new oe({
    ...
    getFileNotFoundAction: e.getFileNotFoundAction ?? Wt,
...
const Bt = "https://api.wordpress.org/core/stable-check/1.0/";
let G;
async function an() {
  G ?? (G = X(globalThis.fetch));
  const e = await G(
    Bt
  );
  if (!e.ok)
...
async function Vt(e, t = "/phpinfo.php") {
  await e.writeFile(
    "/internal/shared/preload/phpinfo.php",
    `<?php
    // Render PHPInfo if the requested page is /phpinfo.php
    if ( isset($_SERVER['REQUEST_URI']) && ${h(
      t
    )} === $_SERVER['REQUEST_URI'] ) {
        phpinfo();
        exit;
...
async function re(e, t, i = {}) {
  ...
  if ($t(n)) {
    const a = await Et(t.stream(), "zstd"), o = await wt(
      a,
      e,
    ...
    await w(e, t, "/tmp/unzipped-wordpress");
  e.fileExists("/tmp/unzipped-wordpress/wordpress.zip") && await w(
    e,
...
class Kt extends Error {
  constructor(t, i) {
    super(
      `WordPress core bundle file-count parity check failed: extracted ${t} files, expected ${i}. The download may be truncated or corrupt.`
    ), this.name = "WordPressBundleFileCountMismatchError";
  }
}
const Qt = X(fetch), zt = "https://github.com/WordPress/WordPress/archive/refs/heads/master.zip";
async function on(e = "latest") {
  if (e === null)
    e = "latest";
...
export {
  Z as PLAYGROUND_MANAGED_DB_PHP_MARKER,
  Tt as StreamingTarParser,
  Kt as WordPressBundleFileCountMismatchError,
  Ct as bootRequestHandler,
  Ft as bootWordPress,
  sn as bootWordPressAndRequestHandler,
  Et as createDecodedTarStream,
  nn as defineWpConfigConstants,
  Ot as ensureWpConfig,
  wt as extractTarStreamToPhp,
  Wt as getFileNotFoundActionForWordPress,
  rn as getLoadedWordPressVersion,
  an as getWordPressStableVersions,
  tn as isZipBundle,
  $t as isZstdBundle,
  Vt as preloadPhpInfoRoute,
  se as preloadSqliteIntegration,
  on as resolveWordPressRelease,
  gt as sanitizeTarPath,
  Xt as setupPlatformLevelMuPlugins,
  re as unzipWordPress,
  Mt as versionStringToLoadedWordPressVersion,
  Ht as wordPressRewriteRules
};
