 ...
 * @param php
 */
export declare function setupPlatformLevelMuPlugins(php: UniversalPHP, options?: {
    phpVersion?: string;
}): Promise<void>;
/**
...
export declare function preloadSqliteIntegration(php: UniversalPHP, sqliteZip: File, options?: SqliteIntegrationOptions): Promise<void>;
/**
 ...
 * as that's viable.
 */
export declare function unzipWordPress(php: PHP, wpZip: File, options?: {
    expectedFileCount?: number;
}): Promise<void>;
export declare class WordPressBundleFileCountMismatchError extends Error {
