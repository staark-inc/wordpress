import { Semaphore as F, decodeBase64ToUint8Array as k, normalizePath as u, joinPaths as v } from "@php-wasm/util";
import { Octokit as R } from "octokit";
import { StreamedFile as f } from "@php-wasm/stream-compression";
import { ZipReader as m, BlobReader as g, BlobWriter as A } from "@zip.js/zip.js";
function j(i) {
  return new R({
    auth: i
  });
...
async function Y(i, t) {
  ...
  for await (const n of t) {
    ...
    s ? U(s, a) || e.update.set(n.path, a) : e.create.set(n.path, a);
  }
...
function w() {
  return import("./git-sparse-checkout-BYAiBP5U.js");
}
function O() {
  return import("./git-create-dotgit-directory-eXm6Gus2.js");
}
async function dt(...i) {
